...
SDCard::SDCard(const char *mount_point, gpio_num_t miso, gpio_num_t mosi, gpio_num_t clk, gpio_num_t cs)
{
  ...
  host.max_freq_khz = 10000; //4MHz works with most boards. Default doesn't work with all boards, increasing speed might improve performance but might break functionality depending on breakout board. 
